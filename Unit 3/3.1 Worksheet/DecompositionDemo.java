public class DecompositionDemo {
    public class DecompositionDemo {
        ...
        // collects data on how many steps and active minutes a person does each hour
        // makes sure that the intervals of steps and min are equal to the num of hours
        // avgs act min per day
        // prints report
        // avg steps per day
        // variable dataset
        public static void bigMethodToDecompose() {
            ...
            double avgSteps = calculateAverageSteps();
            ...
            System.out.println("Total steps: " + results[3]);
            System.out.println("Average steps/hour: " + round2(results[4]));
            System.out.println("Min steps in an hour: " + results[0]);
            System.out.println("Max steps in an hour: " + results[1] + " at hour " + results[2]);
    ...
    public static double[] calculateAverageSteps() {
        ...
        results[0] = minSteps;
        results[1] = maxSteps;
        results[2] = maxStepsHour;
        results[3] = totalSteps;
        results[4] = totalSteps / (double) hours.length;
        return results;
    }
}
